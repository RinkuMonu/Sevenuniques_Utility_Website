    ...
    <section className="relative bg-[#e8f0f7] rounded-xl flex flex-col md:flex-row justify-between items-start gap-10 shadow-sm md:mt-18">
      ...
      <div className="max-w-xl p-8 md:ml-6">
        ...
        <p className="text-gray-700 mt-6 leading-relaxed text-base relative">
          You should use this form in case you have not yet applied to obtain a PAN or you do not possess a PAN. There is a place on the Income Tax Department site where you can check whether a PAN has been allotted to you or not.<br />
SevenUniques provides the service of online PAN cards, in which the digital PAN card is provided within a limited time, and the entire online submission is done via our <span className="font-bold">online PAN service portal</span>. The <span className="font-bold">PAN card online quick service</span> method is a paperless and smooth experience.
