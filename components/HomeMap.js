...
const HomeMap = () => {
  ...
  return (
    <section className="relative w-full py-6 overflow-hidden">
      ...
      {/* ✅ CONTENT */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:pl-10 grid md:grid-cols-2 items-center gap-12">
        ...
        <div>
          ...
          <div className="w-full max-w-4xl bg-white/10 backdrop-blur-sm rounded-2xl  py-5 shadow-2xl overflow-hidden">
