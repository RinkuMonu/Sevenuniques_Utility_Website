...
const page = () => {
  const cards = [
    {
      title: "Correction of pancard easily",
      desc: "It has made it very easy and safe to correct or update your pancard. You may require the name correction in the pancard, address correction, or any other detail; our service of pancard correction online will be a hassle-free experience. You may amend your PAN details via the correct form (Form 49A or 49AA) and correct your e-pancard (which is delivered electronically) online.",
    },
    {
      title: "Correction of pancard Online",
      desc: "Begin pancard correction on the Internet by completing the correction form correctly. Make sure that all your personal information, i.e., full name, date of birth, and contact details, is consistent with supporting documents. We have pancard correction services provision to enable you to make the application within a short time and follow up without any hassles.",
    },
    {
    ...
    },
    {
      ...
      desc: "Enclose valid documents as evidence of identity and evidence of address, and a recent passport-size photograph. The documents that are acceptable are Aadhaar Card, Passport, Driving License, and so on, according to the governmental regulations. Ensure that files are clear and legible. This is a requirement of e-KYC pancard correction.",
    },
    {
      title: "Make Payment Securely",
      desc: "Make payments online through a secure gateway by paying the PAN processing fee. One can pay through UPI, debit/credit card, or net banking. The cost of a standard pancard correction is approximately (in addition to taxes and convenience fees, which vary depending on the mode of payment).",
    },
    {
      title: "Documents needed to correct PAN.",
      desc: "Make sure that you have supportive documents to make the process go smoothly. The documents that are usually needed are an Aadhaar card, a passport, a driving license, or any other government-issued identity card. These are documents that are required for the correction of names in pancards, address correction, or any other corrections.",
    },
    {
      title: "Need Assistance?",
      desc: "In case you have any problems when filing your PAN correction application, our support staff is at your side to help. We have pancard correction services, and your application gets done within a short time and in the right way, and in a safe manner.",
    },
    {
      title: "Ready to Apply?",
      desc: "Once you start a pancard correction online, you will be ready. You can easily update your details through pancard form 49A correction or form 49AA correction, and your corrected pancard is delivered to your doorstep.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          <h1 className="text-4xl font-bold text-gray-900 mb-3">
            pancard Correction Made Simple
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Correct or modify pancard details on the internet, like name,
        ...
        <div className="text-center mt-16">
          ...
          Try hassle-free PAN correction services like e-pancard correction online.
          </p>
          <Link
