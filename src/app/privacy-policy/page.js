...
import { Shield, Database, UserCheck, Share2, Lock, Clock, User, Cookie, Link, Child, Phone, RefreshCw, FileText } from "lucide-react";
...
We encourage all users to read this policy carefully to understand how we handle your information and to exercise your rights effectively.`
    },
    {
        ...
        content: `At Sevenunique Tech Solutions Private Limited, we are committed to collecting only such information that is necessary for providing our financial and utility services in a safe, secure, and legally compliant manner. The categories of information we may collect include:

a) Personal Information — such as your full name, contact details, Aadhaar, PAN, and KYC-related data.
b) Financial Information — including bank details, UPI IDs, wallet data, and transaction history.
c) Technical Information — like IP address, device details, and usage logs.
d) Service-Related Information — including transaction IDs, AEPS logs, and bill payment records.
...
Disclaimer: All information collected is used only for lawful, service-related, and regulatory purposes.`
    },
    {
        ...
        content: `Your information is used solely to deliver secure and compliant services.
a) Processing Transactions — For BBPS, AEPS, DMT, and other payments.
b) Identity Verification — For KYC and AML compliance under RBI/NPCI/UIDAI.
c) Security & Fraud Prevention — To detect and prevent unauthorized access.
d) Customer Support — For grievance handling and dispute resolution.
e) Notifications — To send alerts, updates, and confirmations.
f) Service Improvement — To enhance reliability and user experience.
...
Disclaimer: Your data is never sold or misused beyond the purposes stated herein.`
    },
    {
        ...
        content: `We do not sell or rent user data. However, your data may be shared:

a) With Regulators — RBI, NPCI, UIDAI, and other authorities for compliance.
b) With Service Providers — Banks, payment gateways, and telecom partners for processing transactions.
c) For Legal Obligations — When required by law or court orders.
d) During Business Transfers — In mergers or acquisitions, under this same policy.
...
Disclaimer: We ensure that any third party receiving data maintains equivalent protection standards.`
    },
    {
        ...
        icon: <Share2 />,
        title: "Data Security",
        content: `We prioritize the confidentiality and integrity of all user information.
a) Encryption — All sensitive data is encrypted and transmitted securely.
b) Access Controls — Only authorized personnel can access data.
c) Fraud Monitoring — Continuous surveillance for suspicious activities.
d) Infrastructure Protection — Firewalls, intrusion detection, and audits.
e) Data Minimization — We retain only what’s necessary for compliance.
f) User Responsibility — Users must safeguard login and OTP credentials.
...
Disclaimer: Despite all measures, no system is 100% secure; usage implies consent.`
    },
    {
        ...
        content: `We retain data only as long as required for business or legal reasons.
a) Legal Compliance — RBI, NPCI, and UIDAI mandate certain retention periods.
b) Support — Retained for grievance resolution and dispute handling.
c) Security Logs — Stored for fraud monitoring and compliance.
d) Data Minimization — Deleted or anonymized once no longer required.
e) User Rights — Deletion requests are honored unless restricted by law.
...
a) Access — View personal and financial data we hold about you.
b) Correct — Request updates to inaccurate or outdated information.
c) Delete — Request deletion of personal data (subject to legal limits).
d) Opt-Out — Restrict non-essential communications.
e) Raise Concerns — Contact our Grievance Officer for any issues.
...
Disclaimer: Some rights may be limited under Indian financial laws.`
    },
    {
        ...
        content: `We use cookies and similar technologies to improve service functionality and security.
a) Purpose — To enhance navigation, analytics, personalization, and fraud detection.
b) Types — Essential, performance, functional, and analytical cookies.
c) Control — Users may block cookies, though it may limit platform functionality.
...
Disclaimer: By continuing to use our platform, you consent to our cookie usage.`
    ...
    },
    {
        ...
        content: `In compliance with Indian law, we have appointed a Grievance Officer to address privacy-related concerns.
                                    ...
                                    <div className="bg-white p-8 rounded-2xl shadow-sm mb-8">
                                        <div className="text-center mb-10">
                                            ...
                                            <p className="text-[#0C3D4C] text-start text-lg leading-relaxed">
                                                <span className="font-bold">Effective Date:</span> 28-09-2025 <br />
                                                <span className="font-bold">Company:</span> Sevenunique Tech Solutions Private Limited <br />
                                                <span className="font-bold">Registered Office:</span> Plot No 97, Dakshinpuri - I, Shrikishan, Sanganer, Jagatpura, Jaipur,  Rajasthan, India - 302017 <br />
                                                <span className="font-bold">Corporate Office:</span> Office No. 101/2, ‘Vakratunda Corporate Park Premise Co-operative Society Limited, Off. Aarey Road, Goregaon (East), Mumbai - 400 063
