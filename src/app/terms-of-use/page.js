...
const termsSections = [
  {
    ...
    content: [
      "These Terms and Conditions govern the commercial arrangement between Finunique Small Private Limited and the appointed Retailer, Partner, Distributor, or API Partner (hereinafter collectively referred to as “Partner”). This agreement, along with any attachments, represents the entire understanding between Finunique Small Private Limited and the Partner. Any amendments or changes to this agreement shall be valid only if made in writing and authorized by an official representative of Finunique Small Private Limited.",
      "Finunique Small Private Limited is a digital financial facilitation service provider, incorporated under the Companies Act, 2013, with its registered office at Plot No. 97, Dakshinpuri-I, Shrikishanpura, Sanganer, Jagatpura, Jaipur – 302017, Rajasthan. The term “Company” or “Finunique Small Private Limited” shall, unless repugnant to the context, include its successors and permitted assigns."
  ...
  },
  {
    ...
    content: [
      ...
      "1.6 Business Hours and Outlet Availability\nThe Partner shall ensure that the outlet remains open during normal business hours or as specified by Finunique Small Private Limited, and in compliance with applicable laws and regulations. Any changes to the business hours must be approved by the Company.",
      ...
      "1.8 Training, Technology Support, and Promotional Materials\nFinunique Small Private Limited, at its discretion, may provide training manuals, technology support, ongoing guidance, and promotional materials such as brochures, charts, signage, and pamphlets. These materials must be used solely for the promotion and provision of Finunique Small Private Limited Services and cannot be repurposed for other activities.",

      "1.9 Non-Interference with Other Partners\nThe Partner shall not encroach upon or interfere with the operational areas of other appointed Partners and shall not undertake any action that may adversely affect the business operations or prospects of other Partners appointed by Finunique Small Private Limited."
    ]
  },
  {
    ...
    content: [
      ...
      "Applicant: Any individual above 18 years of age, using an operational mobile phone connection, who approaches a Retail Partner, Distributor, or API Partner at authorized outlet locations to avail Finunique Small Private Limited Services.",

      "Company Rules: Policies issued by Finunique Small Private Limited for its strategic partners, Retail Partners, and Distributors, including codes of conduct, sales and management policies, and operational guidelines as published on the Website/Platform and amended from time to time.",

      "Consumer: An Applicant who, after completing necessary formalities and submission of required documents, is found eligible by Finunique Small Private Limited to avail Services and has opened a Membership Account.",
  ...
  },
  {
    ...
    icon: <Shield className="w-5 h-5" />,
    content: [
      "Finunique Small Private Limited may collect, store, and use information provided by the Partner to deliver services and/or contact the Partner regarding operational or transactional matters.",
  ...
  },
  {
    ...
    content: [
      ...
      "3.2 Acknowledgement of Terms\nThe Partner acknowledges that they have read and understood these Terms at the time of application to Finunique Small Private Limited for operating a retail outlet or API services. The Partner confirms that they have evaluated:",
      ...
      "3.3 Appointment of Partner\nDuring the Term, Finunique Small Private Limited appoints the Partner to establish and operate a retail outlet or API services at the address specified in the Application Form (“Retail Outlet” or “API Operations”). Any change in address requires prior written consent from the Company, signed by an authorized representative (VP level or above).",

      "3.4 Term of Appointment\nThe appointment shall remain valid until termination (“Term”). Finunique Small Private Limited may withdraw the appointment by providing 1 (one) month written notice, except in cases of breach of these Terms by the Partner, where withdrawal may be immediate.",

      "3.5 Use of Designation\nThe Partner may describe themselves as an authorized Retailer / Distributor / API Partner of Finunique Small Private Limited, but shall not represent themselves as able to bind the Company in any manner. They shall not portray themselves as employees, officers, or official representatives of the Company.",

      "3.6 Nature of Business\nFinunique Small Private Limited acts as a facilitator, distributor, and provider of services and products of various service providers, enabling Partners to expand the distribution network. The Company does not own the services/products provided by third parties.",
  ...
  },
  {
    ...
    content: [
      ...
      "4.5 Prices and Discounts\nAll service prices, charges, fees, and discounts shall be determined solely by Finunique Small Private Limited.",
...
},
{
  ...
  content: [
    ...
    "a) Competing Services: Market, sell, offer, or perform any services that are identical or substantially similar to the services facilitated by Finunique Small Private Limited under BBPS, AEPS, DMT, or any other digital financial services.",
...
},
{
  ...
  content: [
    "8.3 Security of POS User ID and Password\nThe Retailer, Distributor, or API Partner shall be solely and exclusively responsible for safeguarding the confidentiality and security of their User ID, login credentials, and passwords relating to access of Finunique Small Private Limited services or any associated accounts.",
    ...
    "Finunique Small Private Limited shall not be liable for any loss, damage, or liability incurred due to the Retailer’s or Distributor’s failure to maintain strict confidentiality of such credentials.",

    "8.4 Unauthorized Access\nThe Retailer, Distributor, or API Partner shall take all necessary precautions to prevent unauthorized or illegal use of Finunique Small Private Limited services and unauthorized access to their accounts provided by the Company.",
    ...
    "- Finunique Small Private Limited shall not be responsible or liable.",
    "- The full responsibility shall remain with the Retailer/Distributor/API Partner.",
    "Finunique Small Private Limited shall take all commercially reasonable and technologically viable measures to protect its platform and prevent unauthorized access. However, the ultimate responsibility of securing login credentials rests with the Retailer/Distributor/API Partner.",

    "8.5 Fraud / Fake Transactions\nFinunique Small Private Limited shall not be held responsible or liable for any fraudulent, fake, or unauthorized transactions carried out by any third party using the Retailer’s/Distributor’s/API Partner’s login credentials or account.",
    "While Finunique Small Private Limited implements strong encryption and security protocols to safeguard user data and transactions, it cannot control the misuse of sensitive information such as login credentials or passwords once shared with the Retailer/Distributor/API Partner.",
    "Accordingly, the Retailer/Distributor/API Partner shall:",
    "- Strictly follow all standard security guidelines issued by Finunique Small Private Limited for protecting login credentials.",
...
},
{
  ...
  content: [
    ...
    "(a) Promptly, effectively, efficiently, and professionally sell, market, distribute, and promote the Services of Finunique Small Private Limited, and shall promptly respond to all inquiries raised by any customer or potential customer in relation to such Services.",
    "(b) At all times co-operate with representatives of Finunique Small Private Limited, and promptly report any complaints, grievances, or customer feedback relating to the Services which may come to its notice.",
    "(c) Conduct all operations strictly in compliance with applicable laws, the Terms and Conditions of this Agreement, and all guidelines, circulars, or instructions issued by Finunique Small Private Limited from time to time.",
    "(d) Promote and safeguard the business interests and reputation of Finunique Small Private Limited.",
    "(e) Not undertake or omit, or cause to be undertaken or omitted, any act, deed, or activity, directly or indirectly, which may cause financial loss, reputational harm, or any damage whatsoever to Finunique Small Private Limited.",
    ...
    "(i) Ensure adherence by its employees, subordinates, agents, or representatives to the professional conduct, dress code, and etiquette prescribed by Finunique Small Private Limited from time to time.",
    "(j) Ensure that none of the Services are denied to any person or group of persons, except with the express written consent or instructions of Finunique Small Private Limited.",
    "(k) Not engage in any form of unfair, unlawful, or unethical trade or practice.",
    "(l) Not permit unauthorized persons to enter the Retail Outlet, nor allow any unauthorized person to access computers, servers, or systems at the Retail Outlet, or to access any information, material, accounts, or records related to Finunique Small Private Limited Services.",
    "(m) Not permit any other individual or entity to conduct any business, trade, or professional activity of any nature at the Retail Outlet without the prior written approval of Finunique Small Private Limited.",
    ...
    "9.2 The Retailer / Partner / Distributor agrees that it shall be solely liable and responsible for any seizure, confiscation, or inquiry by governmental or statutory authorities relating to any instruments, devices, or materials provided by Finunique Small Private Limited, arising out of any actual or alleged illegal or unlawful activity.",

    "9.3 The Retailer / Partner / Distributor shall be solely responsible for obtaining and maintaining adequate insurance coverage, including but not limited to cash handling insurance and transit insurance, to safeguard the business of Finunique Small Private Limited from time to time.",

    "9.4 The Retailer / Partner / Distributor undertakes to ensure that the consumer information including contact details, phone numbers, and any other credentials captured on the platform of Finunique Small Private Limited are genuine, authentic, and obtained directly from the customer. The Retailer / Partner / Distributor shall not insert, use, or substitute its own, fake, or inaccurate credentials on behalf of the customer under any circumstances.",

    "9.5 During the Term of this Agreement, the Retailer / Partner / Distributor shall provide Finunique Small Private Limited, or any statutory authority, auditor, regulator, or authorized representative, unrestricted access to inspect, examine, audit, and/or take copies of any records, books, or documents in relation to the Services.",

    "9.6 The Retailer / Partner / Distributor shall co-operate with internal and external auditors, regulators, and representatives of Finunique Small Private Limited, and ensure prompt and accurate audit of its records and data. Further, the Retailer / Partner / Distributor agrees to co-operate in good faith and use best efforts to rectify any deficiencies or irregularities identified during such audits within a reasonable period of time.",

    "9.7 The Retailer / Partner / Distributor shall diligently perform its responsibilities under this Agreement and shall strive to maximize the sales of Finunique Small Private Limited Services to the best of its ability. The Retailer / Partner / Distributor shall always maintain a transparent and professional relationship with customers, and any specified Distributor under this Agreement."
  ]
},
{
...
},
{
  ...
  content: [
    ...
    "(c) Make unauthorized use of Finunique’s Intellectual Property or proprietary technologies.",
...
},
{
  ...
  content: [
    ...
    "In such cases, the successors in interest, new management, or permitted assignees of the partnership or company may continue to operate the Retail Outlet only after obtaining prior written consent from Finunique Small Private Limited.",

    "12.3 Mandatory Consent\nIn both situations above (individual or firm/company), Finunique Small Private Limited reserves the sole right to approve or deny such continuation. This ensures that the operations of the Retail Outlet remain in accordance with the standards, compliance requirements, and business interests of Finunique Small Private Limited."
  ]
},
{
  id: "TERMINATION",
  ...
  content: [
    "13.1 Expiry of Term\nThese Terms and Conditions shall automatically cease to have effect upon the expiry of the contractual Term, unless renewed or extended by Finunique Small Private Limited in writing.",

    "13.2 Termination Without Cause\nEither Party (Finunique Small Private Limited or the Retailer/Partner/Distributor) may terminate this Agreement without assigning any reason, by providing a written notice of thirty (30) days to the other Party.",

    "13.3 Termination by Finunique Small Private Limited with Notice\nFinunique Small Private Limited shall be entitled to terminate the appointment of any Retailer/Partner/Distributor by giving thirty (30) days’ written notice under the following circumstances:",
    ...
    "b) Breach of any obligation concerning Finunique Small Private Limited Intellectual Property.",
    "c) Repeated failure to deposit proceeds of daily transactions as required.",
    "d) Finunique Small Private Limited, upon review, determines that the Retailer/Partner/Distributor is not suitable or fit to continue operations.",
    ...
    "13.4 Immediate Termination Without Notice\nFinunique Small Private Limited may immediately terminate the appointment of the Retailer/Partner/Distributor without prior notice in the following cases:",
    "a) Actions or defaults by the Retailer/Partner/Distributor that cause damage to the reputation or goodwill of Finunique Small Private Limited.",
    ...
    "13.5 Termination with Short Notice\nFinunique Small Private Limited reserves the right to terminate the appointment of any Retailer/Partner/Distributor by providing a written notice of seven (7) days, with or without assigning any reason.",

    "13.6 Consequences of Termination\nTermination under this clause shall be without prejudice to any other legal rights or remedies available to Finunique Small Private Limited. Upon termination:",
    "a) Within fifteen (15) days from termination, the Retailer/Partner/Distributor shall settle and clear all dues payable to Finunique Small Private Limited.",
    "b) Immediately return all Confidential Information, documents, training materials, software, hardware, POP material, and any other property belonging to Finunique Small Private Limited.",
    "c) Cease to use Finunique Small Private Limited Intellectual Property, including trade names, software, signboards, banners, or marketing material.",
    "d) Permanently delete or remove all software provided by Finunique Small Private Limited from its systems and provide remote access to allow Finunique Small Private Limited to verify and disable installations.",
    "e) Grant Finunique Small Private Limited access to its IT systems for up to ninety (90) working days post-termination for compliance and disabling activities.",
    "f) Cease all promotion, marketing, and advertising activities related to Finunique Small Private Limited and its services.",

    "13.7 Obligations During Notice Period\nOnce termination notice is served, or upon expiry of the Term, the Retailer/Partner/Distributor shall strictly comply with all systems, processes, and service guidelines during the final one (1) month of operation. All customer queries shall be redirected to Finunique Small Private Limited.",

    "13.8 Continuation of Services During Notice Period\nIf directed by Finunique Small Private Limited, the Retailer/Partner/Distributor shall continue to provide services during the notice period, until otherwise instructed.",

    "13.9 Settlement of Accounts\nUpon termination, both Parties shall reconcile and settle all financial claims. The Retailer/Partner/Distributor acknowledges that it shall have no right to claim compensation, damages, loss of profit, or opportunity cost of any kind from Finunique Small Private Limited post-termination."
  ]
},
{
  id: "INDEMNITY",
  ...
  content: [
    ...
    "c) Unauthorized Representations – Any loss, claim, or damage caused due to the Retailer/Partner/Distributor providing false, misleading, or unauthorized representations to third parties, customers, or stakeholders on behalf of Finunique Small Private Limited.",

    "d) Intellectual Property Infringement – Any claim, demand, or proceeding arising from the Retailer/Partner/Distributor’s infringement, misuse, or unauthorized use of Finunique Small Private Limited’s Intellectual Property during the course of providing services under this Agreement.",

    "e) Employment and Labour Law Claims – Any claim made by the Retailer/Partner/Distributor’s employees, staff, agents, or personnel against Finunique Small Private Limited in relation to employment disputes, salary claims, benefits, or non-compliance with labour laws, social security laws, or statutory obligations.",
    ...
    "14.3 Right to Defend\nFinunique Small Private Limited shall have the right, at its sole discretion, to assume the defense of any claim or legal action brought against it. In such an event, the Retailer/Partner/Distributor shall fully cooperate with Finunique Small Private Limited in defending such claims and shall not settle or compromise any claim without prior written approval of Finunique Small Private Limited."
  ]
},
...
},
{
  ...
  content: [
    "The Retailer / Partner / Distributor / Super Distributor hereby expressly agrees and consents that Finunique Small Private Limited may communicate with him/her/it through various modes including but not limited to voice calls, SMS, WhatsApp, email, mobile app notifications, video messages, or any other digital/innovative means of communication as deemed appropriate by the Company.",
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm mb-8">
                      <div className="text-center mb-10">
                        ...
                        <h3 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 mt-4">
                          Terms and Conditions – Finunique Small Private Limited
                        </h3>
                        <div className="h-1 w-20 bg-gradient-to-r from-[#358EBA] to-[#24576C] mx-auto mb-6 rounded-full"></div>
                        <p className="text-gray-600 text-lg leading-relaxed">
                          By accessing this webpage or application, you agree to be bound by these Terms and Conditions (“Terms”) in a legally binding agreement between you (“User” or “you”) and Finunique Small Private Limited(“Company” or “we” or “us” or “our”). Please read these Terms carefully before using or accessing the Website/App. If you do not agree to these Terms, you may not use or access the Platform.
                        </p>
                      </div>
                    </div>
                    {termsSections.map((section, index) => (
